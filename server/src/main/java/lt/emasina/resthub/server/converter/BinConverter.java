...
public interface BinConverter {
    ...
    Representation convert(BinHandler handler, final Reference ref, CcBin bin) throws Exception;
//    public Representation convert(BinHandler handler, final Reference ref, CcBin bin) throws Exception{
//
